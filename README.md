...
> Safe generate and validate csrf tokens

[![PyPI version](https://badge.fury.io/py/safe-csrf-token.svg)](https://pypi.org/project/safe-csrf-token/)
...
from safe_csrf_token import batch
